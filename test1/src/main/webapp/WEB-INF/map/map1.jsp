<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <body>
        <div id="app">
            ...
            <select v-model="categoryCode" @change="fnSearch" style="margin-bottom : 20px; padding:5px">
    ...
    <script>
        const app = Vue.createApp({
            ...
            methods: {
                ...
                fnSearch() {
                    ...
                    for (let i = 0; i < self.markerList.length; i++) {
                        self.markerList[i].setMap(null);  // marker를 지도에서 제거
                    }
                    self.markerList = [];

                    self.ps.categorySearch(self.categoryCode, self.placesSearchCB, { useMapBounds: true });
                }
            ...
            mounted() {
                ...
                // 카테고리로 은행을 검색합니다
                // ps.categorySearch("BK9", self.placesSearchCB, { useMapBounds: true });   원래코드
