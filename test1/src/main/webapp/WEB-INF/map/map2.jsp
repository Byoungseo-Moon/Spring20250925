        ...
        const app = Vue.createApp({
            ...
            methods: {
                ...
                searchPlaces() {
                    ...
                    this.ps.categorySearch(this.currCategory, placesSearchCB, { useMapBounds: true });
                },
            ...
            mounted() {
                ...
                // 지도에 idle 이벤트를 등록합니다
                kakao.maps.event.addListener(self.map, 'idle', this.searchPlaces);
                ...
                addEventHandle(self.contentNode, 'mousedown', kakao.maps.event.preventMap);
                addEventHandle(self.contentNode, 'touchstart', kakao.maps.event.preventMap);
